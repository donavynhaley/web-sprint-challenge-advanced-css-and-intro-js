...
*/
function getArtistByIndex(newArray, id) {
    return `The artist at index ${newArray[id].id} is ${newArray[id].name}`
  }
...
function getHTML(data){
  for (const key in data){
    console.log(
      ...
      <div id="artist">
      <div class="image">
          <img src="assets/${data[key].name}.jpg"/>
      </div>
      <div class = "name">
        <a href="https://en.wikipedia.org/wiki/${data[key].name}"> ${data[key].name}</a>
      </div>
